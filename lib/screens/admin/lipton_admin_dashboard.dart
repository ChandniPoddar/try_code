                      ...
                      SliverToBoxAdapter(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text("Outlet Insights", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 18)),
  ...
  Widget _buildHeader(BuildContext context, Color primaryRed) {
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        centerTitle: true,
        title: Text("LIPTON HUB", style: GoogleFonts.metamorphous(color: primaryRed, fontSize: 18, fontWeight: FontWeight.bold)),
  ...
  Widget _buildStatsGrid(int total, double revenue, Color primaryRed) {
    return GridView.count(
      ...
      children: [
        ...
        _buildStatCard("Tea Sold", "$total", Icons.emoji_food_beverage_outlined, primaryRed),
      ],
    );
  }
    ...
    return SliverPadding(
      ...
      sliver: SliverList(delegate: SliverChildBuilderDelegate((context, index) {
        ...
        return Container(
          ...
          child: Row(children: [
            Icon(Icons.coffee_outlined, color: primaryRed, size: 30),
            const SizedBox(width: 16),
