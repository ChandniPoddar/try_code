                      ...
                      SliverToBoxAdapter(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text("Outlet Analytics", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 18)),
  ...
  Widget _buildHeader(BuildContext context, Color primaryRed) {
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        centerTitle: true,
        title: Text("NESCAFÉ HUB", style: GoogleFonts.metamorphous(color: primaryRed, fontSize: 18, fontWeight: FontWeight.bold)),
  ...
  Widget _buildStatsGrid(int total, double revenue, Color primaryRed) {
    return GridView.count(
      ...
      children: [
        ...
        _buildStatCard("Orders", "$total", Icons.shopping_bag_outlined, primaryRed),
      ],
    );
  }
    ...
    return SliverPadding(
      ...
      sliver: SliverList(delegate: SliverChildBuilderDelegate((context, index) {
        ...
        return Container(
          ...
          child: Row(children: [
            Icon(Icons.coffee_maker_outlined, color: primaryRed, size: 30),
            const SizedBox(width: 16),
